    ...
    return (
        ...
        <footer className="footer">
            <div className="footer__redes">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-envelope-open-heart-fill" viewBox="0 0 16 16">
            ...
            <div>
                <p className="footer__direccion">Ituzaingó 551, X5000 Córdoba</p>
                <p className="footer__copyright">&copy;CeramicLoversClub, todos los derechos reservados</p>
            </div>
